...
function Theme_Based_Wedding() {
    ...
    return (
        <>
            ...
            <div className="Wedecore-Theme_Based_Wedding">
                <div className="position-2">
                    <h1 style={{ fontSize: "35px", color: "rgb(254,174,163)" }}>Theme-Based Wedding Planning
                    </h1>
                    <h4 style={{ fontSize: "20px", color: "white" }}> <Link className='link' style={{ color: "white" }} to="/"> Home</Link> / Theme-Based Wedding Planning
                    </h4>
                </div>
            </div>
...
export default Theme_Based_Wedding